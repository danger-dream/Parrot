    ...
    async def build_upstream_request(
        ...
        *, ingress_protocol: str = "responses",
        ...
        payload = codex_oauth_transform.apply_codex_oauth_transform(
            ...
            support_verbosity=model_policy.support_verbosity,
            supports_reasoning_summary_parameter=model_policy.supports_reasoning_summary_parameter,
            ...
            ultra_reasoning_effort_fallback=codex_protocol_profile(prov_cfg).ultra_reasoning_effort_fallback,
