...
_MIGRATIONS: dict[str, str] = {
    ...
    "cache_status": "ALTER TABLE image_call_logs ADD COLUMN cache_status TEXT",
    "cache_error_class": "ALTER TABLE image_call_logs ADD COLUMN cache_error_class TEXT",
    ...
    with _lock:
        ...
        conn.execute(
            """UPDATE image_call_logs SET
                 ...
                 cache_error_class=COALESCE(?, cache_error_class),
                 error_type=?, error_message=?,
